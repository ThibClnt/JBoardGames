...
/**
 * Bishop piece for chess. This piece can move only in diagonals (i.e. on squares of a same color) and has a value of 3.
 */
public class Bishop extends ChessPiece{
     ...
     */
    public Bishop(ChessBoard board, Player player, Pos pos) {
        super(board, player, pos, ChessPieceType.BISHOP);
    }
     ...
     */
    public Bishop(ChessBoard board, Player player, int x, int y) {
        super(board, player, new Pos(x, y), ChessPieceType.BISHOP);
    }
